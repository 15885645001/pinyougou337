...
import com.itheima.core.service.ContentCategoryService;
...
public class ContentCategoryController {
    ...
    public Result update(@RequestBody ContentCategory contentCategory) throws
            Exception {
        try {
    ...
    @RequestMapping("/add")
    public Result add(@RequestBody ContentCategory contentCategory) throws
            Exception {
        try {
    ...
    public PageResult search(@RequestBody ContentCategory contentCategory, Integer
